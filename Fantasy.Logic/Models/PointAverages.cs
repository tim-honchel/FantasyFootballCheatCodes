namespace Fantasy.Logic.Models
{
    public class PointAverages
    {
        ...
        public double FATQB { get; set; } = 0;
        public double FAK { get; set; } = 0;
        public double FAP { get; set; } = 0;
        public double FADEF { get; set; } = 0;
        public double FADT { get; set; } = 0;
        public double FADE { get; set; } = 0;
        public double FALB { get; set; } = 0;
        public double FACB { get; set; } = 0;
        public double FAS { get; set; } = 0;
        public double FAHC { get; set; } = 0;
    }
}
